 ...
 * In the binded with [BindViewHolder] ViewHolder, you should use ${prefix}${FieldName}In${DecomposedFieldName}${postfix}() functions in your viewHolder for each field of your decomposed value.
 *
 */
@Target(AnnotationTarget.PROPERTY)
@Retention(AnnotationRetention.SOURCE)
